...
export class OrderItemMysqlRepo extends BaseMysqlRepo implements IOrderItemRepository{
    create(o: OrderItemCreate): ResultAsync<void, Err> {
        const query = `INSERT INTO order_item (order_id, sku_id, amount, description, unit_price, discount) VALUES (?, ?, ?, ?, ?, ?)`;
        return this.executeQuery(query,
            [o.orderId, o.skuId, o.amount, o.description, o.unitPrice, o.discount]
        ).andThen(
            ([r, f]) => {
